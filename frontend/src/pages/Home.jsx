  ...
  return (
    <div className="relative overflow-x-hidden bg-background text-text">
      ...
      <main className="pt-20 md:pt-20">
        ...
        <footer className="border-t border-luxury/10 bg-white pb-24 pt-16 lg:pb-10">
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] lg:px-8">
            ...
            <div>
              <h3 className="font-semibold text-luxury">About</h3>
              <ul className="mt-4 space-y-3 text-sm text-muted">
                <li><a href="#story" className="transition-colors hover:text-gold">Our story</a></li>
                <li><a href="#best-sellers" className="transition-colors hover:text-gold">Best sellers</a></li>
                <li><a href="#new-arrivals" className="transition-colors hover:text-gold">New arrivals</a></li>
                <li><a href="#journal" className="transition-colors hover:text-gold">Journal</a></li>
              </ul>
            </div>
          ...
          <div className="mx-auto mt-12 flex max-w-7xl flex-col gap-4 border-t border-luxury/10 px-4 pt-6 text-sm text-muted sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
            <p>© 2026 Jewelry Maison. All rights reserved.</p>
